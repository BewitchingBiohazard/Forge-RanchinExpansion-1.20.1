...
public class LonghornEntity_F extends Animal {
    public LonghornEntity_F(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
            SynchedEntityData.defineId(LonghornEntity_F.class, EntityDataSerializers.INT);
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.LONGHORN_F.get().create(serverLevel);
    }
