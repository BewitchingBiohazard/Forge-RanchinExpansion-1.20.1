...
public class HampshireEntity_F extends Animal {
    public HampshireEntity_F(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.HAMPSHIRE_F.get().create(serverLevel);
    }
