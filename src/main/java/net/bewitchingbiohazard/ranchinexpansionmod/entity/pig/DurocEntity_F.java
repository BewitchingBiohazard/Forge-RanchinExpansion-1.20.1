...
public class DurocEntity_F extends Animal {
    public DurocEntity_F(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.DUROC_F.get().create(serverLevel);
    }
