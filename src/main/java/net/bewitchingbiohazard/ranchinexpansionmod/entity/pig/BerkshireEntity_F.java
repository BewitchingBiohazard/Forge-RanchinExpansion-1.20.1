...
public class BerkshireEntity_F extends Animal {
    public BerkshireEntity_F(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.BERKSHIRE_F.get().create(serverLevel);
    }
