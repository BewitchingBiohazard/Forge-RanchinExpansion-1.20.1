...
public class LandraceModelF<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Eyes = Head.addOrReplaceChild("Eyes", CubeListBuilder.create().texOffs(4, 2).addBox(-3.75F, -0.4F, 0.0F, 0.8F, 0.4F, 0.25F, new CubeDeformation(0.0F))
		.texOffs(1, 2).addBox(-2.1F, -0.4F, 0.0F, 0.8F, 0.4F, 0.25F, new CubeDeformation(0.0F)), PartPose.offset(2.65F, -4.4F, -5.55F));
